...
export default function CookModePage() {
  ...
  const { recipes, isLoading: isContextLoading } = useAppContext();
  ...
  }, [params.id, recipes, isContextLoading, router, toast]);
    ...
    <div className="container mx-auto py-8">
      ...
      <Card className="overflow-hidden">
        <CardHeader className="p-0 relative">
          <Image src={recipe.image} alt={recipe.title} width={800} height={400} className="w-full h-auto max-h-[400px] object-cover" data-ai-hint={recipe.dataAiHint} />
          ...
          <div className="mt-6 space-y-4">
            <h3 className="font-bold text-xl font-headline">Instructions</h3>
             {recipe.steps && recipe.steps.length > 0 ? (
                ...
                <p className="text-muted-foreground">No detailed steps provided. Follow the description.</p>
            )}
          </div>
        </CardContent>
      </Card>
